...
mixin _$ContentsStore on _ContentsStoreBase, Store {
  late final _$contentsAtom =
      Atom(name: '_ContentsStoreBase.contents', context: context);
  ...
  late final _$isLoadingAtom =
      Atom(name: '_ContentsStoreBase.isLoading', context: context);
  ...
  late final _$getContentsAsyncAction =
      AsyncAction('_ContentsStoreBase.getContents', context: context);

  @override
  Future<void> getContents(String categoryId) {
